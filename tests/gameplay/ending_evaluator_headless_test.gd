...
func _test_imbalance_boundaries() -> void:
	...
	_assert_ending("", 100.0, 70.0, 50.0, true, true, phase_config)
	_assert_ending("", 100.0, 90.0, 50.0, true, true, phase_config)
...
func _test_ending_priority() -> void:
	var phase_config = PHASE_1_CONFIG_SCRIPT.new()
	_assert_ending(CONFIG.SUCCESS_ENDING, 0.0, 50.0, 100.0, true, true, phase_config)
	_assert_ending(CONFIG.SUCCESS_ENDING, 100.0, 60.0, 100.0, true, true, phase_config)
